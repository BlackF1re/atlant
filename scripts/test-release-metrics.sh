...
require 'api.github.com%2Frepos%2FBlackF1re%2Fatlantian%2Freleases%3Fper_page%3D1' "$readme"
require 'label=image%20downloads' "$readme"
require '%5B%5Cs%5CS%5D%2A%3F%22download_count%22' "$readme"
