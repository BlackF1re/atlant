...
require 'github/downloads/BlackF1re/atlantian/total?label=release%20downloads' "$readme"
reject 'releases%3Fper_page%3D1' "$readme"
reject 'label=image%20downloads' "$readme"
